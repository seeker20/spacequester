...
{LIST}
<tr>
<td>{USID}</td><td>{USNAME}</td><td>{USFILE}</td><td align='center'><a href='main.php?editsite={USNAME}'><img title='Bearbeite die Seite' alt='Edit' src="{IMAGE_PATH}/edit.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;<a href='main.php?delsite={USNAME}'><img title='Löscht die Seite' alt='Delete' src="{IMAGE_PATH}/delete.gif" border="0" /></a></td>
</tr>
{/LIST}
</table>
<br />
