...
{READYFORINSTALL}
<tr><td>Install Ready</td><td><a href='{URL}' target='_blank' title='{URL}'>{NAME}</a></td><td>{VERSION}</td><td>{MINV}-{MAXV}</td><td>{DESC}</td><td><a href='main.php?inst={ID}'>Install</a>/<a href='main.php?lri={ID}'><img src='{IMAGE_PATH}/delete.gif' border='0' alt='Löschen' title='Löscht das Aktuelle Modul.'></a></td></tr>
{/READYFORINSTALL}

{INSTALLT}
<tr><td>Installiert</td><td><a href='{URL}' target='_blank' title='{URL}'>{NAME}</a></td><td>{VERSION}</td><td>{MINV}-{MAXV}</td><td>{DESC}</td><td><a href='main.php?conf={ID}'><img src='{IMAGE_PATH}/edit.gif' border='0' alt='Bearbeiten' title='Das Aktuelle Modul bearbeiten.'></a>/<a href='main.php?deinst={ID}'>Deinstaliern</a>/<a href='main.php?linst={ID}'><img src='{IMAGE_PATH}/delete.gif' border='0' alt='Löschen' title='Löscht das Aktuelle Modul.'></a></td</tr>
{/INSTALLT}
