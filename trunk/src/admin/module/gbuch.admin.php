...
if(isset($_GET["ne"])) {
	...
	if($name==""||$name=="Name") {
		echo "<font color='red'>Sie müssen einen Namen für den Eintrag geben.</font><br>\n";
	}
	else if($email==""||$email=="E-mail") {
		echo "<font color='red'>Sie müssen eine Email adresse angeben.</font><br>\n";
	}
